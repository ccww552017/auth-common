...
import (
	...
	versioned "github.com/ccww552017/auth-common/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/ccww552017/auth-common/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/ccww552017/auth-common/pkg/generated/listers/auth/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CebpassV1().Users(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CebpassV1().Users(namespace).Watch(context.TODO(), options)
			},
		},
		&authv1.User{},
		resyncPeriod,
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&authv1.User{}, f.defaultInformer)
}
